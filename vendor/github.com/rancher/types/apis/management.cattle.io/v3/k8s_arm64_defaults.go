...
var (
	...
	AllArm64K8sVersions = map[string]RKESystemImages{
		...
		"v1.12.4-rancher1-1": {
			...
			Kubernetes:                m("jianghang8421/hyperkube:v1.12.4-rancher1"),
			Alpine:                    m("jianghang8421/rke-tools:v0.1.21"),
			NginxProxy:                m("jianghang8421/rke-tools:v0.1.21"),
			CertDownloader:            m("jianghang8421/rke-tools:v0.1.21"),
			KubernetesServicesSidecar: m("jianghang8421/rke-tools:v0.1.21"),
